...
const LoginForm = () => {
  ...
  return (
    <div 
      className="bg-auth-bg dark:bg-none dark:bg-page-body min-h-screen flex items-center justify-center p-4.5 relative overflow-hidden flex-col"
      style={{
        backgroundImage: `url(${getUrlWithBasePath("/assets/images/admin.png")})`,
